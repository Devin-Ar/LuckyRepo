// src/features/Game2/view/Game2View.tsx
...
export const Game2View: React.FC<IGameViewProps<Game2Presenter, Game2Controller>> = ({vm, controller}) => {
    ...
    useEffect(() => {
        const unsubscribe = vm.subscribe(() => {
            ...
            // Map the new schema values from VM
    ...
    return (
        <div style={{
            ...
            <div style={{
                color: '#adadad', fontSize: '10cqw', fontWeight: 'bold',
            ...
            <Game2HUD
                ...
                onQuickLoad={() => controller.resetLevel()} // Updated to resetLevel
            />
        </div>
    );
};