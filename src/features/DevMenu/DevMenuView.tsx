                ...
                <div style={{flex: 2}}>
                    ...
                    <div style={{
                        ...
                        <div style={{display: 'flex', flexDirection: 'column', gap: '0.5cqw'}}>
                            ...
                            <div style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '0.5cqw'}}>
                                <DevButton label="LVL 1" onClick={() => handleNav(BHState, true, BHLevel.Level1)}
                                           color="#8e44ad"/>
                                <DevButton label="LVL 2" onClick={() => handleNav(BHState, true, BHLevel.Level2)}
                                           color="#2980b9"/>
                                <DevButton label="LVL 3" onClick={() => handleNav(BHState, true, BHLevel.Level3)}
                                           color="#27ae60"/>
                            </div>
                        </div>
